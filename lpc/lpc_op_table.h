...
#ifndef LPC_OP_TABLE_H
#define LPC_OP_TABLE_H
...
# endif
    ...
    LPC_OP_OK | LPC_OP_FETCH_IN | LPC_OP_FETCH_OUT, /* 80 = ZEND_FETCH_R */
    LPC_OP_OK,                                      /* 81 = ZEND_FETCH_DIM_R */
    LPC_OP_OK,                                      /* 82 = ZEND_FETCH_OBJ_R */
    LPC_OP_OK | LPC_OP_FETCH_IN | LPC_OP_FETCH_OUT, /* 83 = ZEND_FETCH_W */
    ...
    LPC_OP_OK | LPC_OP_FETCH_IN | LPC_OP_FETCH_OUT, /* 89 = ZEND_FETCH_IS */
    LPC_OP_OK,                                      /* 90 = ZEND_FETCH_DIM_IS */
    LPC_OP_OK,                                      /* 91 = ZEND_FETCH_OBJ_IS */
    LPC_OP_OK | LPC_OP_FETCH_IN | LPC_OP_FETCH_OUT, /* 92 = ZEND_FETCH_FUNC_ARG */
