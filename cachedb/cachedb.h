...
PHPAPI int _cachedb_find( cachedb_t*  db,  char  *key,   size_t key_len TSRMLS_DC);
PHPAPI int _cachedb_fetch(cachedb_t*  db,  zval *value TSRMLS_DC);
PHPAPI int _cachedb_add(  cachedb_t*  db,  char  *key,   size_t key_len, zval *value TSRMLS_DC);
...
#define cachedb_find(db,k,kl)   _cachedb_find(db,k,kl TSRMLS_CC)
#define cachedb_fetch(db,v)     _cachedb_fetch(db,v TSRMLS_CC)
#define cachedb_add(db,k,kl,v)  _cachedb_add(db,k,kl,v TSRMLS_CC)
